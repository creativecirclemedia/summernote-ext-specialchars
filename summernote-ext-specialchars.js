  ...
  $.extend($.summernote.plugins, {
    'specialchars': function (context) {
      ...
      var specialCharDataSet = [
            ...
            '&uacute;', '&ucirc;', '&uuml;', '&yacute;', '&thorn;', '&yuml;', '&OElig;', 
            '&oelig;', '&Scaron;', '&scaron;', '&Yuml;', '&fnof;', '&iquest;', '&iexcl;', 
            '&acute;', '&circ;', '&tilde;', '&lsquo;', '&rsquo;', '&sbquo;', '&ldquo;', 
            '&rdquo;', '&bdquo;', '&prime;', '&Prime;', '&lsaquo;', '&rsaquo;', '&laquo;', 
            '&raquo;', '&ndash;', '&mdash;', '&bull;', '&hellip;', '&cent;', '&euro;', '&pound;', 
            '&curren;', '&yen;', '&sect;', '&copy;', '&reg;', '&trade;', '&deg;', '&para;', 
